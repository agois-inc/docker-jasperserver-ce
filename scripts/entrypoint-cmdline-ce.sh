...
apply_customizations() {
  ...
  if [ -d "$BUILDOMATIC_CUSTOMIZATION" ]; then
	  echo "Deploying Customizations from $BUILDOMATIC_CUSTOMIZATION"

	  BUILDOMATIC__CUSTOMIZATION_FILES=`find $BUILDOMATIC_CUSTOMIZATION -iname "*zip" \
